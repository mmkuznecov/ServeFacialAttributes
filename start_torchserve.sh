...
MODELS="baldness beard emotions face_detection gender glasses happiness headpose ita race age dlib_face_segmentation deeplab_face_segmentation apparent_skincolor arcface"
